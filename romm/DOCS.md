...
ROMM uses **port 5999** (fixed) for the web interface. This port is mapped by Home Assistant and cannot be changed through app configuration.
...
MariaDB instance before installing this app.

Options:

1. Install a MariaDB app from the Home Assistant app Store
...
4. Start the app
6. Open Web UI: `http://YOUR_HA_IP:5999` (or click "Open Web UI" button in app interface)
...
For app issues, report at: <https://github.com/rigerc/ha-apps/issues>
