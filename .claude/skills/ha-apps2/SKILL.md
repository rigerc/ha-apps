...
- ✅ Include all supported architectures in config.yaml (amd64, aarch64)
...
arch:
  - amd64|aarch64                      # Supported architectures
ports:
...
| Build fails with "Unknown architecture" | config.yaml lists unsupported arch | Use only: amd64, aarch64 |
...
- [ ] All listed architectures are supported (amd64, aarch64)
